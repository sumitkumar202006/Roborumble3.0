  ...
  return (
    <div className="min-h-screen bg-[#020617] flex relative z-10">
      ...
      >
        ...
        <Link
          href="/"
          className="group p-5 border-b border-gray-800/50 block hover:bg-white/5 transition-colors"
        >
            ...
            <div className="pt-4 mt-4 border-t border-gray-800/50">
              ...
              <div className="space-y-1 mt-1">
                {channels.map((channel) => {
                  const isActive =
                    pathname === `/dashboard/channels/${channel.eventId}`;
                  ...
                  if (isLocked) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-[10px] bg-gray-700/50 px-1.5 py-0.5 rounded text-gray-500">
                          Locked
                        </span>
                      </div>
                    );
