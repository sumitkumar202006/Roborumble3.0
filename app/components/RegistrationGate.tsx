        ...
        try {
            ...
            if (res.ok) {
                if (data.registered) {
                    ...
                    fetch("/api/auth/cleanup-unauthorized", { method: "POST" }).catch(console.error);
                }
            } else {
                            ...
                            <div className="p-8 text-center space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-gray-400 text-sm leading-relaxed">
                                        Your email <span className="text-white font-mono">({user?.primaryEmailAddress?.emailAddress})</span> is not found in our records. Please register first to participate in Robo Rumble 3.0.
                                    </p>
                                </div>
